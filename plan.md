...
`Codestructure.md` before doing senior-care work. Update its checkboxes and evidence after
...
- [x] `max30102_read.py` exposes structured prepare and capture behavior while retaining its CLI.
...
- [ ] Keep `Codestructure.md` synchronized with implemented architecture.
